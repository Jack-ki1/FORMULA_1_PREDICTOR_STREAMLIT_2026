...
Usage:
    from f1_predictor.engine.optimized_simulation import simulate_race_vectorized
...
def simulate_race_vectorized(
    ...
    from f1_predictor.engine.probability_model import compute_confidence_intervals
...
def benchmark_simulations(circuit_id: str = "canada", n_runs: int = 5000):
    ...
    from f1_predictor.engine.probability_model import simulate_race as original_simulate
